...
Correctness is enforced by four automated layers: issue review (Stage~2), compile-time type checks, unit tests, and agentic feature tests (Stage~4).
The first three are standard; only agentic feature tests, described below, are novel to this work.
