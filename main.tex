...
Integer linear programming (ILP) serves as the gateway to mature solvers: any path from a problem to ILP grants access to those solvers.
Such access is crucial for testing the correctness of reductions.
