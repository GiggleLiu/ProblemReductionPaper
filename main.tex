...
We evaluate two questions. First, how much library does the harness actually produce? Second, does that library change what end-user agents do on a concrete problem?
