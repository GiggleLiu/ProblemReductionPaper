...
Correctness is enforced by a four-layer wrapper around the codebase: issue review (Stage~2), compile-time type checks, unit tests, and agentic feature tests (Stage~4).
