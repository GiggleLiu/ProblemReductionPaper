...
The library layer (\Cref{fig:library-architecture}) is a collection of problem types and the reduction rules between them, with a database of canonical instances for tests and documentation.
