...
Decades of work on reduction libraries (Appendix~\ref{sec:related}) have steadily widened the gap between \emph{known} and \emph{implemented} reductions: Garey and Johnson~\cite{garey1979} catalogue over 300~NP-hard problems with reduction sketches, yet the largest software implementation covers fewer than 20.
