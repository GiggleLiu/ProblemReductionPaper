...
The command-line interface (CLI) \texttt{pred} is the friendly entry point for users and AI agents.
\texttt{create} emits a problem instance as JSON, \texttt{reduce} transforms it along any reduction path, and the resulting JSON pipes into external solvers or downstream tools.
