...
\begin{wrapfigure}{r}{0.45\textwidth}
  ...
  \caption{Delegation spectrum, sorted from fully human (top) to fully automated (bottom).
    Bars show the human--agent split for each work type.
    Harness engineering (skills, specs, tools), strategic planning (priorities, roadmap), and merge authorization (security, final approval) remain fully human; mathematical verification (correctness, proofs) and canonical examples (ground truth instances) are human-led with agent drafting; code review (structure, correctness, feature tests), implementation (code, tests, documentation), and convention enforcement (naming, layout, checks) are delegated to agents.}
