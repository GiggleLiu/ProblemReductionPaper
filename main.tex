...
\begin{figure*}[t]
  ...
  \footnotesize
  \begin{lstlisting}[basicstyle=\ttfamily\footnotesize, numbers=none, frame=none, aboveskip=0pt, belowskip=0pt, xleftmargin=4pt, breaklines=true, breakindent=2em, postbreak=\mbox{\textcolor{gray}{$\hookrightarrow$}\space}]
---
name: propose
description: Guides domain experts through brainstorming and files a GitHub issue
---
  \end{lstlisting}
  \vspace{-4pt}
  ...
  \begin{lstlisting}[basicstyle=\ttfamily\footnotesize, numbers=none, frame=none, aboveskip=-5pt, belowskip=2pt, xleftmargin=4pt, breaklines=true, breakindent=2em, postbreak=\mbox{\textcolor{gray}{$\hookrightarrow$}\space}]
