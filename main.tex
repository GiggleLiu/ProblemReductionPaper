...
\begin{figure}
  ...
  \caption{Overview.
    (a) Many solvers exist, and a problem can usually reach several of them through different reductions; without an executable tool to formulate and compare these paths, choosing the best one is guesswork.
    (b) A harness-engineered agentic workflow turns a structured GitHub issue into validated reduction code through implementation and review agents under a four-layer verification stack.
    (c) Three months of this pipeline produced a reduction graph with 190 problem types and 265 rules, with growth concentrated in the full-pipeline phase.}
  \label{fig:overview}
\end{figure}
...
The library is therefore most useful where the obvious encoding is suboptimal but a stronger one exists via reduction.
