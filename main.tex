...
The catalog itself is a practical contribution to combinatorial optimization: any of the 129~problems with an ILP path can be solved end-to-end through a single \texttt{pred} invocation.
