...
\textbf{For end users.}
Two interactive workflows that map a real-world problem to a solving strategy via reductions, or, conversely, identify all problems a given solver can handle.
