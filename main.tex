...
These results demonstrate utility in the regime where direct encodings are dominated by reachable reformulations.
Outside this regime---instances without applicable reductions, or where direct solving suffices---the catalog incurs token cost without functional benefit.
