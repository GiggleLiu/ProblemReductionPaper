...
Compiled from Typst source by the build system, the manual collects the library's formal mathematics: each problem and reduction has a definition, a worked example, a diagram, and a proof sketch.
