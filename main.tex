...
Configurations form a $2{\times}2$ factorial over \emph{web search} (yes/no) and \texttt{pred} \emph{access} (yes/no), with ten random instances per cell (40 runs) and a 90~s solver wall-time cap.
