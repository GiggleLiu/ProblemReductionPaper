...
\Cref{tab:end-user-eval} summarizes the outcomes: both catalog-enabled configurations match the per-instance best on every instance and cut solver wall-time by a factor of $4$--$8$, at the cost of roughly $2{\times}$ more AI tokens.
Both bare configurations miss the per-instance best on multiple instances; bare AI (no web) drops 9.8\% below the best on its worst run, bare AI + web drops 20.6\% on each of its two worst runs.
The misses share a single failure mode: the agent commits to a textbook integer-programming formulation, whose linear relaxation is too loose for the solver to close within 90~s.
...
+ \texttt{pred}                      & 12{,}603 & 12{,}187 & 10/10 & 84{,}773 & 10.8 \\
...
In about three months, a small team and AI agents built a verified reduction graph of 190 problem types and 265 reduction rules, with 129 types (68\%) reaching ILP and 78 reaching 3-SAT. An agent calls the library and gets a verified path from a user-stated problem to a fast solver, supplying the practical judgment AI agents lack: knowing in advance which approach will actually work.
...
37 & 12{,}471          & 12{,}471          & 12{,}471         & 12{,}471 & 12{,}471 \\
41 & 12{,}187          & 12{,}187          & 12{,}187         & 12{,}187 & 12{,}187 \\
\midrule
\textbf{mean} & 12{,}431 & 12{,}074 & \textbf{12{,}603} & \textbf{12{,}603} & 12{,}603 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
 7 & 75.1 & 26.7 &  6.2 &  5.9 \\
11 & 11.8 & 80.0 &  3.0 &  4.7 \\
13 & 80.2 & 70.0 &  1.3 &  4.7 \\
17 & 75.1 & 11.5 &  0.9 &  4.7 \\
19 & 86.0 & 80.1 &  0.8 &  3.0 \\
23 & 18.5 & 80.2 & 70.0 &  1.6 \\
29 & 24.9 &  2.3 &  5.9 &  5.8 \\
31 & 17.7 & 80.1 &  9.5 & 29.4 \\
37 & 32.0 & 80.1 &  2.4 &  5.9 \\
41 & 60.0 & 30.5 &  8.4 &  1.2 \\
\midrule
\textbf{mean} & 48.1 & 54.2 & \textbf{10.8} & \textbf{6.7} \\
\bottomrule
\end{tabular}
\end{table}
