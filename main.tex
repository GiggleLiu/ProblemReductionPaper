...
The Rust compiler points to the error location, names the conflicting types or lifetimes, and often suggests a fix.
Agents parse and resolve these without human help.
