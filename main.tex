...
Reduction-graph construction supplies one for free: every reduction admits a \emph{closed-loop unit test}---reduce a small canonical instance, solve the target, lift the solution back, and compare against an independent direct solve of the source.
