...
Scaling a reduction graph is an engineering problem.
Decades of work on reduction libraries (Appendix~\ref{sec:related}) have steadily widened the gap between \emph{known} and \emph{implemented} reductions.
...
Implementation and maintenance are the bottleneck.

The reduction graph's value grows with every edge, but so does the cost of maintaining it.
Two barriers in particular emerge.

\emph{Convention drift.}
...
As contributors accumulate their own patterns, the codebase fractures.
