...
We test this on a dense weighted Max-Cut instance ($n{=}150$, ${\approx}5300$ signed edges) presented to a sub-agent in domain language, with no algorithmic hints.
