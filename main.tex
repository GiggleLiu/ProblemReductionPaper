...
A no-code contribution route that walks contributors through brainstorming a new problem model or reduction rule in mathematical language and ends in a well-formed GitHub issue, with no familiarity with the implementation language needed (\Cref{sec:method}).
...
\textbf{For end users.}
A practitioner can ask ``how do I solve this problem?'' and get a reduction path; a solver owner can ask ``what else can my solver handle?'' and get a list of reducible problems.
