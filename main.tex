...
\begin{wrapfigure}{r}{0.4\textwidth}
  ...
  \caption{The reduction graph.  Two anchor problems are highlighted: \emph{3-SAT} at the top and \emph{ILP} at the bottom right.  Edge labels are reduction overheads $r_{\cdot \leftarrow \cdot}$; node labels like $t_S$, $t_I$ denote the time complexity of the node's best known solver.}
