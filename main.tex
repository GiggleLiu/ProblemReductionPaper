...
A skill-based agentic harness that absorbs the implementation, testing, verification, and documentation work that would otherwise grow with every new edge (\Cref{sec:skills}).
