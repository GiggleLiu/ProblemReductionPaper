...
A path from a well-established NP-complete problem like 3-SAT, the source of NP-hardness proofs, to a problem~$H$ provides an NP-hardness argument for~$H$.
We say $H$ is \emph{NP-hard certified} by the reduction graph.
A path from a problem to integer linear programming (ILP), the gateway to mature solvers, grants access to those solvers.
