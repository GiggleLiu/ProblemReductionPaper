...
\textbf{Final review.}
A maintainer reading the PR before merge (Stage~5) catches mismatches the earlier layers miss: most often a builder that quietly encodes a different problem from the one in the issue, or a judgment call where the automated review's confidence is misleading.
