...
\textbf{For end users.}
A single-command tool that translates any source problem into a form solvable by an off-the-shelf solver (SAT, ILP, QUBO, \dots).
The library spans 100+ problem types and 200+ reduction rules across 170k lines of code, built in about three months by a small team and AI agents (\Cref{sec:end-user-utility}).
