...
\begin{enumerate}
  ...
  \item A \emph{multilayer verification stack}: unit and round-trip tests validate each reduction programmatically; domain experts perform end-to-end checks against contributor-specified ground truth (\Cref{sec:verification}).
\end{enumerate}
