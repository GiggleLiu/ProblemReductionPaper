...
Unit tests cover individual models, solvers, and helpers.
Round-trip tests cover each reduction rule end-to-end: from a small canonical source instance, reduce, brute-force solve the target, lift the solution back, and compare against a direct brute-force solve of the source---an oracle the rule never invokes.
