...
To isolate the catalog's contribution, we vary two tools available to the agent---\texttt{pred} access and web search---yielding four configurations in a $2{\times}2$ factorial.
