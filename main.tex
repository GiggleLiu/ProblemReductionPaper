...
---
  ...
  \end{minipage}
  \caption{Two skills that bookend the contribution pipeline: \texttt{propose} (left) gates issue creation by domain experts, and \texttt{add-rule} (right) drives implementation from a validated issue.}
  \label{fig:skills}
\end{figure*}
