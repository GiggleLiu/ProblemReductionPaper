...
\textcolor{red}{The same instance feeds round-trip tests, worked examples in the PDF manual, and the \texttt{pred create --example} command for interactive exploration.}
...
\emph{Solvers.}
\textcolor{red}{Every problem type needs a minimal but reasonably efficient solver, because round-trip testing requires solving each problem exactly.}
