...
\emph{Solvers.}
Every problem type needs a minimal but reasonably efficient solver, because the closed-loop unit tests rely on brute-forcing both the source and the target to validate each reduction.
