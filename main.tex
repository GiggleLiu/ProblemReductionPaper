...
\begin{figure}[t]
  ...
  \caption{Skills architecture.
    (a) The two skill kinds: \emph{advisor} skills keep humans in the loop with the agent throughout, while \emph{automation} skills run end-to-end once invoked. Other agent inputs are omitted for clarity.
