...
\begin{enumerate}
  ...
  \item A \emph{multilayer verification stack} that ensures correctness at every stage: \textcolor{red}{automated unit tests and round-trip tests validate each reduction programmatically}, while domain experts perform end-to-end checks against contributor-specified ground truth (\Cref{sec:verification}).
\end{enumerate}
