...
\begin{wrapfigure}{r}{0.4\textwidth}
  ...
  \caption{The reduction graph: nodes are problem types, edges are reductions labeled by overhead.
    Anchors: paths from 3-SAT certify NP-hardness; paths to ILP grant solver access.}
...
\begin{wrapfigure}{r}{0.4\textwidth}
  ...
  \caption{The integration problem.
    (a) A new reduction does not fit the library's conventions.
    (b) The contributor files a structured issue; an agent handles the rest.}
  \label{fig:comic}
  \vspace{-\baselineskip}
\end{wrapfigure}
...
Together with a project \emph{scaffold} (repository structure, CI, specification files \texttt{CLAUDE.md}/\texttt{AGENTS.md}) and committed \emph{skills}~\cite{Claude2026AgentSkills}---plain-Markdown checklists encoding the project's conventions---this harness directly addresses both convention drift and effort exhaustion.
