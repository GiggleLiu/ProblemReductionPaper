...
Beyond the five automated layers, the Stage~6 walkthrough with the original contributor remains as a final human safeguard, catching mismatches that automation cannot see---most often a builder that quietly encodes a different problem from the one in the issue.
