...
\textbf{For end users.}
Interactive traversal of the library in either direction: from a real-world problem to a solving strategy via reductions, or from a solver to the problems it can handle.
