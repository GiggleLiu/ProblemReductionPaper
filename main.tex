...
\Cref{fig:overview}c shows growth in problem types and reduction rules over three months.
Acceleration is concentrated in the final phase: when the full skill-based pipeline came online at week~8.5, problem types went from 23 to 187 and reduction rules from 52 to 239 in under five weeks.
