...
Most problem types have a reduction path to ILP, directly or through intermediate types, enabling solving via the open-source HiGHS solver by default or commercial optimizers like Gurobi and CPLEX.
