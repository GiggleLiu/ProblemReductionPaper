...
\begin{enumerate}
  \item A \emph{skill-based automation pipeline} built on two kinds of skills: \emph{implementation skills} that let agents autonomously code, test, and document each reduction, and \emph{contributor-facing skills} that guide new contributors and maintainers through the project's conventions (\Cref{sec:skills}).
