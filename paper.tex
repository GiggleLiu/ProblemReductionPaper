...
Correctness in this project begins with the issue, not the code (\Cref{fig:verification-funnel}).
...
\begin{figure}[t]
  ...
  \caption{Verification funnel.
    Candidate contributions are progressively filtered: issue checks reject invalid proposals before implementation, automated tests reject implementation errors, and agentic feature tests surface usability and semantic gaps that unit tests cannot reach.}
