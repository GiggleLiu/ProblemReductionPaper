...
\begin{figure}[t]
  ...
  Following a path through the graph leads from any supported problem to a solver backend. $f$ and $g$ are reduction overheads (polynomials) annotated on the edges.}
...
The simplest edge in the graph illustrates the pattern.
Minimum Vertex Cover (MVC) asks for the smallest set of vertices touching every edge; Maximum Independent Set (MIS) asks for the largest set with no edges between them.
