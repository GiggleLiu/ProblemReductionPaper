...
A path from 3-SAT to a problem~$H$ constitutes an NP-hardness proof for~$H$---we say $H$ is \emph{NP-hard verified} by the graph.
A path from a problem to ILP grants access to commercial solvers (Gurobi, CPLEX), providing a verification oracle for testing reductions end-to-end.
