...
Most problem types have a reduction path to ILP, directly or through intermediate types, enabling solving via commercial optimizers like Gurobi and CPLEX.
