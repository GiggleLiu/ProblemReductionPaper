...
The \emph{maintainer} uses four skills:
\texttt{dev-setup} configures the toolchain,
\texttt{final-review} presents a structured merge-or-hold decision,
\texttt{fix-issue} brainstorms fixes for failing quality checks,
and \texttt{release} manages versioning.
The remaining twelve skills are fully \emph{autonomous}:
...
and \texttt{write-model}/\texttt{write-rule} draft paper entries.
