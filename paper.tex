...
\begin{figure}[t]
  ...
  Following a path through the graph leads from any supported problem to a solver backend. $f$ and $g$ are reduction overheads annotated on the edges.}
...
The full graph contains 27~problem types and 56~directed edges: 45~hand-coded reduction rules plus 11~edges inferred from subtype relationships (e.g., MIS on a geometric subgraph is a special case of MIS on a general graph).
