...
\caption{Skill architecture organized by audience.
  All eighteen skills inherit project conventions from the specification files at the root.
  Five \emph{mentor} skills (tinted) interactively guide a human;
  twelve automation skills run without human intervention.}
