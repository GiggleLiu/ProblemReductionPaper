...
\Cref{sec:graph} describes the library that implements the reduction graph.
\Cref{sec:method} presents the skill-based automation pipeline.
\Cref{sec:evaluation} provides quantitative evidence.
...
The reduction graph described in the introduction is realized as a Rust library with three layers (\Cref{fig:library-architecture}): user-facing interfaces at the top, a core library implementing the graph and its algorithms in the middle, and a compile-time validation layer at the bottom.
...
The previous section described \emph{what} the library contains; this section describes \emph{how} it is built and maintained at scale using AI coding agents.
