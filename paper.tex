...
This decision requires human creativity: assessing whether the reduction is useful, safe, and complete.

The pipeline reveals a clean separation.
Three stages---validate, implement, review---are routine: they follow deterministic checklists and run without human intervention.
Two stages---propose and merge---require creativity and domain judgment.
