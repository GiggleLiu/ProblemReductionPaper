...
The maintainer makes the final quality judgment.
This layer catches errors invisible to automated tests: whether the reduction is genuinely useful, whether the proof sketch is convincing, whether the implementation matches the intent of the original proposal.
