...
For contributors, they can invoke the \texttt{propose} skill to conduct a structured brainstorming session to elicit a new problem or reduction in mathematical language, then file a well-formed GitHub issue, with no programming required.
