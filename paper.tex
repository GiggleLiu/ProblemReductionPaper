...
\begin{enumerate}
  ...
  \item A \emph{no-code contribution route} that lets domain experts continuously integrate new reduction rules by filing structured issues, with no familiarity with the implementation language needed (\Cref{sec:method}).
