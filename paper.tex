...
Scaling agent output without domain-specific verification amplifies defects.
Our correctness assurance mechanism sits between unit tests and formal proofs: it verifies a mathematical property (reduction correctness) automatically, without a proof assistant.
Domain experts review every proof sketch before integration, providing a human safeguard; AI-assisted theorem proving could further strengthen these guarantees with machine-checked proofs.
