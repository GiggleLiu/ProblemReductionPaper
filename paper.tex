...
\end{center}
Overheads chain along paths ($r_{C \leftarrow A} = r_{C \leftarrow B} \circ r_{B \leftarrow A}$).
...
Independently contributed edges combine into chains without coordination.
