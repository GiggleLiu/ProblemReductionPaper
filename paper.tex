...
\begin{figure}[t]
  ...
  \caption{Contribution pipeline mirroring the GitHub project board.
    Three roles drive the flow: a \emph{domain expert} files issues and verifies results, an \emph{agent} implements and reviews (blue), and a \emph{maintainer} triages and merges (orange).
    Failures at any agent stage move the item to On~Hold for human triage.}
  \label{fig:pipeline}
\end{figure}
