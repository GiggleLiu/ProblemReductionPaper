...
\begin{figure}[t]
  ...
  \caption{Contribution pipeline mirroring the GitHub project board.
    Three roles drive the flow: a \emph{domain expert} files issues, an \emph{agent} implements and reviews (blue), and a \emph{maintainer} triages and merges (orange).
