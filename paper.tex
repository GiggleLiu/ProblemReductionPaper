...
\begin{abstract}
Solving an NP-hard optimization problem often requires reformulating it for a specific solver, such as quantum hardware, a commercial optimizer, or a domain heuristic.
