...
SWE-agent~\cite{Yang2024SWEagent}, Devin~\cite{Wu2024Devin}, OpenHands~\cite{Wang2024OpenHands}, and Claude Code~\cite{Anthropic2025ClaudeCode} resolve isolated issues with increasing reliability~\cite{Xia2025LiveSWEagent}, but longer-horizon benchmarks reveal a capability cliff: on SWE-bench Verified, frontier agents exceed 80\% on single-issue fixes, yet SWE-bench Pro~\cite{Deng2025SWEBenchPro} reports only $\sim$23\% on its multi-file tasks and SWE-EVO~\cite{Thai2025SWEEVO} $\sim$21\%; LongCLI-Bench~\cite{LongCLIBench2026} finds pass rates below 20\% on long-horizon CLI tasks.
