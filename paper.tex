...
\emph{The evolving role of humans.} Harness engineering shifts where human effort is spent. In our work, none of the code was written manually; most effort went into the harness itself. This shift---from writing code to designing constraints---is what keeps an AI-coded project maintainable at scale: without a harness enforcing uniform conventions, a codebase grown at agent speed quickly becomes unmanageable. The harness is what makes the output of many short, disposable agent sessions add up to a coherent library rather than a pile of sediment.

\emph{Automation and advisor skills.} We found this distinction useful when designing the harness. Automation skills handle routine work. Advisor skills keep humans more actively involved by lowering the barrier to learning the project's conventions. When an AI agent knows less than the human, its main role is to shoulder routine work. When it knows more, its role shifts toward guidance and onboarding. We expect this distinction to become standard vocabulary in harness design.
