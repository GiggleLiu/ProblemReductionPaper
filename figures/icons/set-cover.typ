...
#canvas({
  ...
  content((-0.65, 0.1), text(text-size, text-blue([S#sub[1] = { 1, 2, 4 }])))
  rect((0.1, 0.3), (1.2, -0.1), radius: 0.05cm, fill: none, stroke: 0.5pt + rgb("#59a14f"))
  content((0.65, 0.1), text(text-size, text-green([S#sub[2] = { 2, 3, 5 }])))
  rect((-1.2, -0.2), (-0.1, -0.6), radius: 0.05cm, fill: none, stroke: 0.5pt + rgb("#83379d"))
  content((-0.65, -0.4), text(text-size, text-purple([S#sub[3] = { 4, 5, 6 }])))
  rect((0.1, -0.2), (1.2, -0.6), radius: 0.05cm, fill: none, stroke: 0.5pt + rgb("#f28e2b"))
  content((0.65, -0.4), text(text-size, text-orange([S#sub[4] = { 1, 6, 7 }])))
