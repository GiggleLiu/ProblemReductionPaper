...
#let panel1 = box(
  ...
  #std.grid(
    ...
    rows: (auto, auto, auto),
    gutter: 6pt,
    problem-tile([3-SAT], icon: image("icons/3sat.svg", width: 1.0cm)),
    problem-tile([Max-Cut], icon: image("icons/max-cut.svg", width: 1.0cm)),
    problem-tile([Set Cover], icon: image("icons/set-cover.svg", width: 1.0cm)),
